<head>
    ...
    <title>Store Assets </title>
</head>

<body>
<div class="example" >
  <h3>Assets in Store Ready For Issuance Report</h3>
  ...
  <table id="emp-table" class="table ">
    ...
    <?php
      ...
      $sql="SELECT * FROM assets WHERE state IN ('Working', 'Disposal', 'Repair','Faulty')
      AND NOT EXISTS ( SELECT * FROM asset_reg WHERE asset_reg.serialno = assets.serialno)";
